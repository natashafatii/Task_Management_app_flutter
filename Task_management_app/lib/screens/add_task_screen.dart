...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  void initState() {
    ...
    _titleController.addListener(_setDirty);
    _descriptionController.addListener(_setDirty);
  }

  void _setDirty() {
    final initialTitle = widget.taskToEdit?.title ?? '';
    final initialDescription = widget.taskToEdit?.description ?? '';
  ...
  Widget _buildPriorityDropdown() {
    ...
    return DropdownButtonFormField<String>(
      ...
      icon: Icon(Icons.arrow_drop_down_rounded, color: colorScheme.onSurface.withOpacity(0.5)),
  ...
  void _showDeleteConfirmation() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete this task? This action cannot be undone.', style: TextStyle(color: colorScheme.onSurface)),
  ...
  @override
  void dispose() {
    _titleController.removeListener(_setDirty);
    _descriptionController.removeListener(_setDirty);
